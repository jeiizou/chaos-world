        ...
        return (
          <div
            className={styleMap({
              ...
              [styles['free-layout__docker__item--active']]: activeWindowId === key,
              [styles['free-layout__docker__item--hidden']]: !windowMap[key].visible
            })}
            key={key}
            onClick={() => {
          ...
          >
            ...
            />
            <div className={styles.item_title}>{windowMap[key].app.info.name}</div>
          </div>
        );
      })}
    </div>
